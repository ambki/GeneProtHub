...
#####Run source script above right in functions_ensembl_query.py and classes.py!!!!!!!!!!1

from classes import Gene, Protein
from print_functions import print_gene_data, print_protein_data, print_uniprot_extended
